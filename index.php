    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
              <button type="button" class="btn btn-primary">Primary</button>
            <h2>Les fleures du mal</h2>
            <p>by BERTAUD Thomas</p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="app/src/img/background.gif" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
              <button type="button" class="btn btn-primary">Primary</button>
            <h2>School Fighter</h2>
            <p>by BESSONNET Charlélie</p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="app/src/img/background.gif" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption d-none d-md-block">
              <button type="button" class="btn btn-primary">Primary</button>
            <h2>Macronie The Game </h2>
            <p>by MUTELET Simon</p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="app/src/img/background.gif" class="d-block w-100" alt="...">
          <div class="carousel-caption d-none d-md-block">
              <button type="button" class="btn btn-primary">Primary</button>
            <h2>L’odysée des planète</h2>
            <p>by SANCHEZ Clara</p>
          </div>
        </div>
        <div class="carousel-item">
          <img src="app/src/img/background.gif" class="d-block w-100" alt="...">
...
<!--PHP-->
<a href="index.php?game=macron">Voter</a>
<br>
